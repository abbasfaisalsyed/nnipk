...
if ( current_user_can( 'administrator' ) )
{
    ...
    $nden_n = ntb_06_04_16_en_ntb;
	
	if ( ! get_user_meta($user_id, 'NTB_notice_ignore_n') ) {
		    ?>
			<div class="updated" id="<?php echo $nden_n;  ?>" style="margin-top:30px; margin-bottom:-20px;"><p>
			...
			<span style="color:red; font-weight: bold;" id="txtClignotantNTB"><?php _e("Very important",'news-ticker-benaceur'); ?></span>&nbsp; <?php _e('If you use a caching plugin, it is necessary in most cases to clear the cache after each animation change', 'news-ticker-benaceur'); ?>
			</p></div>
