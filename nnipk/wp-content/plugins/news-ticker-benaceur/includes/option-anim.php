...
<table class="form-table">
                ...
                <tr valign="top">
                    <th style="font-size: 13px;font-weight:normal;" scope="row"><?php _e('margin top', 'news-ticker-benaceur'); ?></th>
                    <td>
...
<table class="form-table">
				...
				<?php } ?>
					<td>
					<div class="sm_benaceurlist_caps_input-ntb"><input style="font-weight:bold;max-width:100px;text-align:center;" type="text" name="news_ticker_benaceur_width_typing_2" value="<?php echo $ntb_width_typing_2; ?>" /></div>
                   </td>
                </tr>
                <tr valign="top">
                    <th style="font-size: 13px;font-weight:normal;" scope="row"><?php _e('Distance from the right (in screen mobile if direction is rtl and style of mobile is enabled)', 'news-ticker-benaceur'); ?></th>
					<td>
					<div class="sm_benaceurlist_caps_input-ntb"><input style="font-weight:bold;max-width:100px;text-align:center;" type="text" name="news_ticker_benaceur_width_rtl_from_ri_anms_two" value="<?php echo $ntb_width_rtl_from_ri_anms_two; ?>" /></div>
                   </td>
                </tr>
					<tr>
						<td>
...
<table class="form-table">
				...
				<?php } ?>
					<td>
					<div class="sm_benaceurlist_caps_input-ntb"><input style="font-weight:bold;max-width:100px;text-align:center;" type="text" name="news_ticker_benaceur_width_anms_two" value="<?php echo $ntb_width_anms_two; ?>" /></div>
                   </td>
                </tr>
                <tr valign="top">
                    <th style="font-size: 13px;font-weight:normal;" scope="row"><?php _e('Distance from the right (in screen mobile if direction is rtl and style of mobile is enabled)', 'news-ticker-benaceur'); ?></th>
