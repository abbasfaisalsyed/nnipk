...
<?php if ($GLOBALS['pagenow'] == ''.O_G.'' && $_GET['page'] == ''.NS_TR_BEN.''){ ?>
<script <?php echo 'src="' . plugins_url( 'js/min-ben.js', __FILE__ ) . '"'; ?>></script>
<?php } ?>	
...
<?php } else { ?>
.main-NTB {margin:0px 87px 0px 80px;}
...
<?php } else { ?>
#up-sec-sett1,#up-sec-sett2,#up-sec-sett3,#up-sec-sett4 {right:200px;left:200px;}
#up-sec-sett5 {right:200px;left:270px;}
<?php } ?>

</style>

<?php if (isset($_GET['settings-updated']) && $GLOBALS['pagenow'] == O_G && $_GET['page'] == NS_TR_BEN){ ?>
<style>
...
<div style='display:none;' class='ntb-mm4111172p'><?php ntbVerPlug();  ?></div>
<?php } ?>	
        ...
        <div class="main-NTB">
            ...
            <div class="koalapse-NTB">
                ...
                <div style="display: none;" class="koalapse__content-NTB op1" data-panel="panel-1">
                    <p><?php _e("You can ask questions about plugin and settings via this topic:",'news-ticker-benaceur'); ?> <a target="_blank" href="http://benaceur-php.com/1747.aspx" >http://benaceur-php.com/1747.aspx</a> </p>
                </div>
                ...
                <div style="display: none;" class="koalapse__content-NTB op2">
                    <p><?php _e('If you want to translate this plugin to your language then send me the translation files via:', 'news-ticker-benaceur'); ?> <a target="_blank" href="http://benaceur-php.com/?p=32" >http://benaceur-php.com/?p=32</a> </p>
                </div>
...
<div id="go1-setting-ntb"></div><br />
        <h3><?php _e('General settings', 'news-ticker-benaceur'); ?><span style="font-size:30px;position:absolute;margin-top:-4px;cursor: pointer;" id="up-sec-sett1" class="dashicons dashicons-arrow-up-alt2"></span></h3>
...
<table width="80%" cellspacing="1" style="border:1px solid #999999;">
	<tr>
		<td align="center" width="75%" style="border-left:1px solid #999999;">' . $cat_name .'</td>
		<td align="center" width="25%">'. $cat_id . '</td>
	</tr>
</table>  </div>';
}
?>
...
<span id="ntb4-4"></span>
<form id="ntb3" method="post" action="options.php#ntb3" >
       ...
       &nbsp;&nbsp;&nbsp; <td style="font-size: 13px;font-weight:normal;"><?php _e('Hide the plugin rating icon', 'news-ticker-benaceur'); ?></td>
				...
				<br /><br />
					<tr>
						...
						<div class="colwrap-display"><td><?php _e("Export time the XML file GMT+",'news-ticker-benaceur'); ?><div style="position:absolute;margin-top:-15px; margin-left:200px; margin-right:200px;" class="ntb-new"></div> </td></div><br />
					</tr>
...
<table style="margin-top:20px;" >
                   ...
                   <td><?php _e("Do not remove",'news-ticker-benaceur'); ?><div style="position:absolute;margin-top:-15px; margin-left:200px; margin-right:200px;" class="ntb-new"></div></td>
					</tr>
</table>
					<p><?php submit_button(); ?></p>
    </form>
...
<span class="submit-ntb0"><input type="submit" name="submit" style="background:#505050; color:#fff; width:300px; padding:6px; cursor: pointer;" id="ntb0" class="button-benTheme"  value="<?php _e("Save all changes",'news-ticker-benaceur'); ?>"  /></span><br /><br /><br />
...
<div id="go5-setting-ntb"></div><br />
		<div class="metabox-holder">
			<div style="max-width:97%;" class="postbox">
				<h3><span class="DroidArabicKufi"><?php _e('Export settings', 'news-ticker-benaceur');?><div style="position:absolute;margin-top:-15px; margin-left:140px; margin-right:140px;" class="ntb-new"></div></span></h3>
				<div class="inside">
			...
			<div style="max-width:97%;" class="postbox">
				<h3><span class="DroidArabicKufi"><?php _e('Import settings', 'news-ticker-benaceur');?><div style="position:absolute;margin-top:-15px; margin-left:140px; margin-right:140px;" class="ntb-new"></div></span></h3>
				<div class="inside">
