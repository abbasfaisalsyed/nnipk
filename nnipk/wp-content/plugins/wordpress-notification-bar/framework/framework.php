                        ...
                        <div id="side-sortables" class="meta-box-sortables ui-sortable">
                            ...
                            <?php if(1 == 0){ ?>
                                ...
                                <div class="postbox rss-postbox" style="background-color:#d9edf7; background-color:#dff0d8">
                                    <div class="handlediv" title="Click to toggle"><br /></div>
                                    <h3 class="hndle" style="text-align:center;"><span><?php _e("Get SeedProd<br>Use Coupon Code <strong>WNB15<strong><br>to save 15% off!", 'wordpress-notification-bar') ?></span></h3>
                                    ...
                                    <div class="postbox rss-postbox" style="background-color:#d9edf7">
                                        <div class="handlediv" title="Click to toggle"><br /></div>
                                        <h3 class="hndle"><span><?php _e('SeedProd Blog', 'wordpress-notification-bar') ?></span></h3>
                                        <div class="inside">
                                            ...
                                            <ul>
                                                <br>
                                            <li>&raquo; <a href="https://feedburner.google.com/fb/a/mailverify?uri=seedprod"><?php _e('Subscribe by Email', 'wordpress-notification-bar') ?></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
